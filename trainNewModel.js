 ...
 */
 ...
 const SAVE_MODEL_LOCALLY_BUTTON = document.getElementById('saveModelLocally');
 const OBJECT_1_INPUT_BOX = document.getElementById('object1Name');
 const OBJECT_2_INPUT_BOX = document.getElementById('object2Name');
 ...
 SAVE_MODEL_LOCALLY_BUTTON.addEventListener('click', saveModelLocally);
 OBJECT_1_INPUT_BOX.addEventListener('change', object1InputBox);
 ...
 function object1InputBox() {
  OBJECT_1_INPUT_BOX.innerHTML = OBJECT_1_INPUT_BOX   
}
